...
void OGLRenderer::SetShaderLight(Light ** l) {
	...
	glUniform4fv(glGetUniformLocation(currentShader->GetProgram(), "specColour"), 4, (float*)&specColours);
	glUniform1fv(glGetUniformLocation(currentShader->GetProgram() , "lightRadius"),4, radii);

}

void OGLRenderer::SetSingleShaderLight(const Light &l) {
