...
public:
	ParticleEmitter(GLuint texture, float rad = 500.0f);
	...
	*/
	...
	Vector3 GetPosition()					{ return emitterPosition; }

	void	SetEmitterRadius(const float rad) { emitterRadius = rad; }
	float	GetEmitterRadius() { return emitterRadius; }
